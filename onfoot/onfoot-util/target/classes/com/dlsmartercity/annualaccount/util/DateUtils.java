...
public final class DateUtils {
	 ...
	 * 日期格式：yyyy.MM.dd
	 */
	public static String YYYY0MM0DD="yyyy.MM.dd";
	
	/**
	 * 日期格式：yyyy年MM月dd日
	 */
	public static String YYYYNMMYDDR="yyyy年MM月dd日";
	 ...
	 * @return 前后时间的秒差
	 */
	public static long dateDiffSecond(Date startDate, Date endDate) {
	 ...
	 * @return
	 */
	public static String getDateWithYMD(Date date) {
		if (date == null) {
			return null;
		}
	 ...
	 * @return
	 */
	public static int getHoursBTWTwoDate(Date before, Date after) {
		long beforeTime = before.getTime();
		long afterTime = after.getTime();
		return (int) (afterTime - beforeTime) / (1000 * 60 * 60);
	}
